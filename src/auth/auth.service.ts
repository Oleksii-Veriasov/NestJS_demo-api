import { BadRequestException, Injectable, UnauthorizedException, MethodNotAllowedException } from '@nestjs/common';
...
import {userSensitiveFieldsEnum} from 'src/user/enums/protected-field.enum';
